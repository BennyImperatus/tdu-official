...
const MOCK_MEMBERS = {
    hq: [
        { userId: 1, username: "CommanderVance", displayName: "CO. Vance", role: "Unit Commander", robloxId: "5829103" },
        { userId: 2, username: "ChiefOfficerBlake", displayName: "XO. Blake", role: "Executive Officer", robloxId: "1290384" }
    ],
    hr: [
        { userId: 3, username: "CaptainKovacs", displayName: "Capt. Kovacs", role: "Head of Recruitment", robloxId: "3049182" },
        { userId: 4, username: "LieutenantMercer", displayName: "Lt. Mercer", role: "Academy Supervisor", robloxId: "4920193" }
    ],
    staff: [
        { userId: 5, username: "SergeantStone", displayName: "Sgt. Stone", role: "Lead evaluator", robloxId: "9038241" },
        { userId: 6, username: "SergeantSterling", displayName: "Sgt. Sterling", role: "Tactical Lead", robloxId: "2019382" },
        { userId: 7, username: "StaffOfficerReid", displayName: "Officer Reid", role: "Roster Admin", robloxId: "5829013" }
    ],
    "sr-instructors": [
        { userId: 8, username: "SeniorInstCross", displayName: "Inst. Cross", role: "Senior Instructor", robloxId: "1029384" },
        { userId: 9, username: "SeniorInstRhodes", displayName: "Inst. Rhodes", role: "Senior Instructor", robloxId: "4029381" },
        { userId: 10, username: "SeniorInstWinters", displayName: "Inst. Winters", role: "Senior Instructor", robloxId: "8029382" }
    ],
    instructors: [
        { userId: 11, username: "InstMiller", displayName: "Officer Miller", role: "Instructor", robloxId: "9028374" },
        { userId: 12, username: "InstGomez", displayName: "Officer Gomez", role: "Instructor", robloxId: "3029384" },
        { userId: 13, username: "InstFoster", displayName: "Officer Foster", role: "Instructor", robloxId: "2039481" },
        { userId: 14, username: "InstHayes", displayName: "Officer Hayes", role: "Instructor", robloxId: "7029384" }
    ]
};
...
const GALLERY_ITEMS = [
    { src: "roblox_police_academy.png", title: "Academy Graduation Lineup", tag: "Academy" },
    { src: "roblox_tactical_patrol.png", title: "Midnight Highway Patrol Intercept", tag: "Patrol" },
    { src: "roblox_swat_operation.png", title: "Active SWAT Training Exercise", tag: "Tactical" },
    { src: "roblox_police_academy.png", title: "Recruit Physical Assessment", tag: "Training" },
    { src: "roblox_tactical_patrol.png", title: "Tactical Traffic Stop Simulation", tag: "Academy" },
    { src: "roblox_swat_operation.png", title: "Unit Command Briefing", tag: "HQ Briefing" }
];
...
async function initRosterFetcher() {
    ...
    try {
        ...
        const proxiedRolesUrl = `https://corsproxy.io/?url=${encodeURIComponent(rolesUrl)}`;
...
async function attachAvatars(roster) {
    ...
    for (const chunk of chunks) {
        try {
            ...
            const proxiedAvatarUrl = `https://corsproxy.io/?url=${encodeURIComponent(avatarUrl)}`;
...
function initGallery() {
    ...
    container.innerHTML = GALLERY_ITEMS.map((item, idx) => `
        <div class="gallery-item glass-panel" data-index="${idx}">
            <img src="${item.src}" alt="${item.title}" onerror="this.src='https://media.discordapp.net/attachments/1529809950686318622/1531321251719675955/image.png?ex=6a68c98c&is=6a67780c&hm=17f9a1abb490431e87ecce3da8de94764d55c906d17f1d55a999fc618e6ed24b&=&format=webp&quality=lossless'">
